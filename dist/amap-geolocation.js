...
const AMapGeolocation = NativeModules.BCMangoLocation;
 ...
 * @platform android
 */
export function setOnceLocation(isOnceLocation) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setWifiScan(isWifiScan) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setSensorEnable(enable) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setOpenAlwaysScanWifi(isOpen) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setOnceLocationLatest(isOnceLocationLatest) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setNeedAddress(isNeedAddress) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setMockEnable(enable) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setLocationCacheEnable(enable) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setHttpTimeout(timeout) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setGpsFirstTimeout(timeout) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setGpsFirst(isGpsFirst) {
    if (Platform.OS === "android") {
 ...
 * @platform android
 */
export function setLocationPurpose(purpose) {
    if (Platform.OS === "android") {
 ...
 */
export function setGeoLanguage(language) {
 ...
 * @platform ios
 */
export function setDistanceFilter(distance) {
    if (Platform.OS === "ios") {
 ...
 * @platform ios
 */
export function setDesiredAccuracy(desiredAccuracy) {
    if (Platform.OS === "ios") {
 ...
 * @platform ios
 */
export function setPausesLocationUpdatesAutomatically(isPause) {
    if (Platform.OS === "ios") {
 ...
 * @platform ios
 */
export function setAllowsBackgroundLocationUpdates(isAllow) {
    if (Platform.OS === "ios") {
 ...
 * @platform ios
 */
export function setReGeocodeTimeout(timeout) {
    if (Platform.OS === "ios") {
 ...
 * @platform ios
 */
export function setLocatingWithReGeocode(withReGeocode) {
